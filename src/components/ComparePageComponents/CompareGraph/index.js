...
function CompareGraph({ crypto1, crypto2, days }) {
  ...
  const getData = async () => {
    const API_URL = `https://api.coingecko.com/api/v3/coins/${crypto1}/market_chart?vs_currency=inr&days=${days}&interval=daily`;
    ...
    const API_URL2 = `https://api.coingecko.com/api/v3/coins/${crypto2}/market_chart?vs_currency=inr&days=${days}&interval=daily`;
